...
C {blocks/nandgate/schematic/nand.sym} -10 0 0 0 {name=x1}
C {vsource.sym} 280 -220 0 0 {name=V4 value=DC\{vss\} savecurrent=false}
...
C {lab_wire.sym} 280 -280 0 0 {name=p7 sig_type=std_logic lab=avss1p8
}
...
.end
"}
C {lab_wire.sym} 470 -10 0 0 {name=p1 sig_type=std_logic lab=avss1p8
}
C {lab_wire.sym} 470 -130 0 0 {name=p2 sig_type=std_logic lab=b}
C {lab_wire.sym} -30 150 0 0 {name=p3 sig_type=std_logic lab=avss1p8
}
C {lab_wire.sym} -20 -120 0 0 {name=p4 sig_type=std_logic lab=avdd1p8
}
C {lab_wire.sym} -160 -50 0 0 {name=p5 sig_type=std_logic lab=a}
C {lab_wire.sym} -160 40 0 0 {name=p11 sig_type=std_logic lab=b}
...
C {vsource.sym} 470 -70 0 0 {name=V2 value=DC\{vdd\} savecurrent=false}
