...
N -260 -230 -260 70 {lab=#net2}
N -300 70 -260 70 {lab=#net2}
N -300 160 -270 160 {lab=clr}
N -580 -200 -580 -110 {lab=#net1}
N -640 -200 -580 -200 {lab=#net1}
N -580 60 -580 120 {lab=#net3}
N -580 120 -500 120 {lab=#net3}
N -260 -230 -230 -230 {lab=#net2}
N -60 -230 -0 -230 {lab=#net4}
N -0 -230 -0 -130 {lab=#net4}
N 0 40 -0 90 {lab=qb}
N -0 90 230 90 {lab=qb}
N 230 40 230 90 {lab=qb}
N 70 -260 130 -260 {lab=clr}
N -0 -350 -0 -230 {lab=#net4}
N -0 -350 130 -350 {lab=#net4}
...
N 590 -260 620 -260 {lab=qd}
N -500 -60 -480 -60 {lab=clk}
N -700 -60 -660 -60 {lab=clkb}
N -690 -0 -660 -0 {lab=vss}
N -500 -10 -480 -10 {lab=vdd}
N -760 -300 -760 -280 {lab=clk}
N -700 -120 -700 -90 {lab=vss}
N -710 -300 -710 -280 {lab=vdd}
N -180 -330 -180 -310 {lab=clk}
...
C {blocks/transmissiongate/schematic/transmissiongate.sym} -580 40 1 0 {name=x4}
...
C {lab_wire.sym} 70 -260 2 0 {name=p12 sig_type=std_logic lab=clr}
...
C {lab_wire.sym} -480 -60 2 0 {name=p21 sig_type=std_logic lab=clk}
C {lab_wire.sym} -700 -60 2 0 {name=p22 sig_type=std_logic lab=clkb}
C {lab_wire.sym} -690 0 2 0 {name=p23 sig_type=std_logic lab=vss}
C {lab_wire.sym} -480 -10 2 0 {name=p24 sig_type=std_logic lab=vdd}
...
C {lab_wire.sym} -180 -330 1 0 {name=p28 sig_type=std_logic lab=clk}
...
C {lab_wire.sym} -180 -110 1 0 {name=p35 sig_type=std_logic lab=clkb}
...
C {lab_wire.sym} -430 -290 2 0 {name=p46 sig_type=std_logic lab=vss}
