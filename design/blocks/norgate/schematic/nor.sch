...
N -70 -50 -40 -50 {lab=b}
N -70 -170 -70 -150 {lab=a}
N -100 -150 -70 -150 {lab=a}
N -70 -70 -70 -50 {lab=b}
...
C {iopin.sym} -100 -150 2 0 {name=p2 lab=a
}
C {iopin.sym} 0 120 1 0 {name=p5 lab=vss}
C {iopin.sym} 140 -10 0 0 {name=p6 lab=out}
C {iopin.sym} -100 -50 2 0 {name=p7 lab=b
}
C {lab_pin.sym} -70 -170 0 0 {name=p3 sig_type=std_logic lab=a}
C {lab_pin.sym} -70 -70 0 0 {name=p4 sig_type=std_logic lab=b}
